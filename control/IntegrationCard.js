...
sap.ui.define([
    ...
    var IntegrationCard = Card.extend("vistex.control.IntegrationCard", /** @lends sap.ui.integration.widgets.Card.prototype */ {
        metadata: {
            properties: {
    ...
    IntegrationCard.create = function (sType, oConfiguration, oServiceManager, oDataProviderFactory, sAppId, oCard) {
        return new Promise(function (resolve, reject) {
            ...
            var oContent = new vistex.control.CustomContent({
